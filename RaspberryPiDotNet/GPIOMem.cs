...
namespace RaspberryPiDotNet
{
    ...
    public class GPIOMem : GPIO
    {
        ...
        static GPIOMem()
        {
            ...
            if (!bcm2835_init()) throw new Exception("Unable to initialize bcm2835.so library");
        }
        ...
        public override GPIODirection PinDirection
        {
            ...
            set
            {
                    ...
                    // Left to right eval ensures base class gets to check for disposed object access
                {
                    ...
                    if (value == GPIODirection.In) Resistor = GPIOResistor.OFF;
                }
            }
        }
        ...
        public override GPIOResistor Resistor
        {
            ...
            set
            {
                if (Resistor != (base.Resistor = value))
                    // Left to right eval ensures base class gets to check for disposed object access
                {
        ...
        private static bool bcm2835_init()
        {
            return true;
        }

        ////		[DllImport("libbcm2835.so", EntryPoint = "bcm2835_gpio_fsel")]
        private static void bcm2835_gpio_fsel(GPIOPins pin, int mode_out)
        {

        }

        ////		[DllImport("libbcm2835.so", EntryPoint = "bcm2835_gpio_write")]
        private static void bcm2835_gpio_write(GPIOPins pin, bool value)
        {

        }

        ////		[DllImport("libbcm2835.so", EntryPoint = "bcm2835_gpio_lev")]
        private static bool bcm2835_gpio_lev(GPIOPins pin)
        {
            return true;
        }

        ////		[DllImport("libbcm2835.so", EntryPoint = "bcm2835_gpio_set_pud")]
        private static void bcm2835_gpio_set_pud(GPIOPins pin, int pud)
        {

        }

        ////		[DllImport("libbcm2835.so", EntryPoint = "bcm2835_gpio_set_multi")]
        private static void bcm2835_gpio_set_multi(GPIOPinMask mask)
        {
        ...
        private static void bcm2835_gpio_clr_multi(GPIOPinMask mask)
        {

        }

        ////		[DllImport("libbcm2835.so", EntryPoint = "bcm2835_gpio_write_multi")]
        private static void bcm2835_gpio_write_multi(GPIOPinMask mask, bool on)
        {

        }

        ////		[DllImport("libbcm2835.so", EntryPoint = "bcm2835_pwm_set_clock")]
        private static void bcm2835_pwm_set_clock(int divisor)
        {

        }

        ////		[DllImport("libbcm2835.so", EntryPoint = "bcm2835_pwm_set_mode")]
        private static void bcm2835_pwm_set_mode(int channel, int markspace, int enabled)
        {

        }

        ////		[DllImport("libbcm2835.so", EntryPoint = "bcm2835_pwm_set_range")]
        private static void bcm2835_pwm_set_range(int channel, int range)
        {

        }

        ////		[DllImport("libbcm2835.so", EntryPoint = "bcm2835_pwm_set_data")]
        private static void bcm2835_pwm_set_data(int channel, int data)
        {
